//This is a simple chat program that acts as both client and server
//Can handle multiple socket connections (up to 30) and accepts input from the command line  
